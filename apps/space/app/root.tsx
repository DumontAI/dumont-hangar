...
const APP_TITLE = "Dumont Hangar Publish | Make your boards public with one click";
const APP_DESCRIPTION = "Dumont Hangar Publish shares boards and roadmaps publicly.";
