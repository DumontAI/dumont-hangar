...
class DumontOauthInitiateEndpoint(View):
    def get(self, request):
        ...
        try:
            ...
            provider = DumontOAuthProvider(request=request, state=state)
...
class DumontCallbackEndpoint(View):
    def get(self, request):
        ...
        if not code:
            ...
            return HttpResponseRedirect(url)
        try:
            provider = DumontOAuthProvider(request=request, code=code, callback=post_user_auth_workflow)
