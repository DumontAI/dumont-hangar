...
export const meta = () => [
  { title: "Dumont Hangar | Project management by Dumont." },
  ...
  { property: "og:title", content: "Dumont Hangar | Project management by Dumont." },
  {
    property: "og:description",
    content: "Open-source project management tool to manage work items, cycles, and product roadmaps easily",
  },
  { property: "og:url", content: "https://hangar.getdumont.ai/" },
  { property: "og:image", content: "https://app.plane.so/og-image.png" },
  { property: "og:image:width", content: "1200" },
  { property: "og:image:height", content: "630" },
  { property: "og:image:alt", content: "Dumont Hangar - Modern project management" },
  
  { name: "twitter:card", content: "summary_large_image" },
  { name: "twitter:image", content: "https://app.plane.so/og-image.png" },
  { name: "twitter:image:width", content: "1200" },
  { name: "twitter:image:height", content: "630" },
  { name: "twitter:image:alt", content: "Dumont Hangar - Modern project management" },
];
  ...
  return (
    <html lang="en">
      <head>
        ...
        {/* Meta info for PWA */}
        <meta name="application-name" content="Dumont Hangar" />
